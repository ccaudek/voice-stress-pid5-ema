...
For NNE, the original Gaussian model estimated a negative stress effect, median = -0.65 dB, MAD = 0.28, 89\% CI {[}-1.10, -0.21{]}, with P(b1 \textless{} 0) = 0.990. The robust Student-t model produced a somewhat larger negative estimate, median = -0.79 dB, MAD = 0.27, 89\% CI {[}-1.21, -0.36{]}, with P(b1 \textless{} 0) = 0.998.
