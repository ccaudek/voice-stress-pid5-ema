...
# EMA Response-Quality Screening and Participant Exclusions
...
library(knitr)
library(kableExtra) # <--- Pacchetto necessario

mc_contrasts <- tibble::tribble(
  ~Outcome, ~Contrast, ~Estimate, ~CrI_89, ~Direction_probability,
...
knitr::kable(
  mc_contrasts,
  col.names = c("Outcome", "Contrast", "Posterior median", "89\\% CrI", "Directional probability"),
...
## Acoustic features: analyzed parameters and full extracted set
...
# Replication of Moderation Effects Across Measurement Strategies
