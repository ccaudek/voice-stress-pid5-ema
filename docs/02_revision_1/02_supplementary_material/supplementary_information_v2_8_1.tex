...
\section{EMA Response-Quality Screening and Participant Exclusions}\label{ema-response-quality-screening-and-participant-exclusions}
...
\subsection{EMA Protocol, Examination Structure, Compliance, and Exclusions}\label{s-ema-protocol}
...
\subsection{Acoustic features: analyzed parameters and full extracted set}\label{acoustic-features-analyzed-parameters-and-full-extracted-set}
...
\section{Replication of Moderation Effects Across Measurement Strategies}\label{replication-of-moderation-effects-across-measurement-strategies}
