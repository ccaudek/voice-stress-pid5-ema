...
manuscript_text <- paste0(
  ...
  "priors scaled to each outcome's theoretical range. All credible intervals are 89% equal-tailed intervals (quantiles .055/.945); Pr(>0) and Pr(<0) denote the posterior probability of the expected direction. ",
  "Perceived threat was higher before the exam ",
